# Business Model: Manufacture of veneer sheets and wood-based panels
...
## Classification
- Repository: `cloud-itonami-isic-1621` ([github.com/cloud-itonami/cloud-itonami-isic-1621](https://github.com/cloud-itonami/cloud-itonami-isic-1621))
- ISIC Rev.5: `1621` — Manufacture of veneer sheets and wood-based panels
- Domain: `:wood-products/veneer-panel-manufacturing`
- Social impact: :worker-safety :local-economy :resource-efficiency
- Actor: `:wood-panel-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :wood-products/veneer-panel-manufacturing — who wants
...
One managed tenant (:wood-products/veneer-panel-manufacturing):
...
- Do not bypass the `:wood-panel-plant-operations-governor` for production decisions.
