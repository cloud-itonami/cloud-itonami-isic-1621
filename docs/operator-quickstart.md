# Operator Quickstart — Manufacture of veneer sheets and wood-based panels

Shortest path from clone to a verified local dry-run for **ISIC 1621** (`cloud-itonami-isic-1621`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1621.git
cd cloud-itonami-isic-1621
```
...
- Blueprint governor key: `wood-panel-plant-operations-governor`
- Likely source path: `veneerpanel.governor.cljc`
