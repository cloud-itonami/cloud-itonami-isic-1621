(ns veneerpanel.phase
  "Phase 0->3 staged rollout for the wood-panel plant-operations
  coordination actor.
...
(defn verdict->disposition
  "Map a Wood Panel Plant Operations Governor verdict to a base
